...
?>
<form id="frmObservar" method="post" action="<?= SessaoSEI::getInstance()->assinarLink('controlador.php?acao=' . $_GET['acao'] . '&acao_origem=' . $_GET['acao'] . '&id_lista_eliminacao=' . $_GET['id_lista_eliminacao']) ?>">
    <?
