...
class MdGestaoDocumentalIntegracao extends SeiIntegracao {
    ...
    public function verificaArquivamentoEmEdicao($dblIdProcedimento, $iconeProcesso = false){
        ...
        if ($bolArquivado) {
            if ($iconeProcesso){
                ...
                '.PaginaSEI::montarTitleTooltip('Processo Retornado para Corre��o','M�dulo Gest�o Documental').'><img
            ...
            if($objMdGdArquivamentoDTO->getStrSituacao() == MdGdArquivamentoRN::$ST_FASE_EDICAO){
                if ($iconeProcesso){
                    ...
                    //Se for montar icone na tela de Controle Processos
                    $arrObjArvoreAcaoItemAPI[] = '<a href="javascript:void(0);"
                    '.PaginaSEI::montarTitleTooltip('Processo em Edi��o','M�dulo Gest�o Documental').'><img
    ...
    public function montarBotaoProcesso(ProcedimentoAPI $objProcedimentoAPI) {
       ...
       // $objAtividadeDTO->setOrdStrSiglaUnidade(InfraDTO::$TIPO_ORDENACAO_ASC);
        ...
        // Verifica a exist�ncia de uma unidade de arquivamento
        ...
        // Verifica a exist�ncia de registros de hist�rico de arquivamento
        $objMdGdArquivamentoDTO = new MdGdArquivamentoDTO();
        ...
        // Bot�o de hist�rico de arquivamento
        if ($bolAcaoHistoricoArquivamento && $objMdGdArquivamentoRN->contar($objMdGdArquivamentoDTO) > 0) {
            $arrBotoes[] = '<a href="' . SessaoSEI::getInstance()->assinarLink('controlador.php?acao=gd_arquivamento_historico_listar&acao_origem=arvore_visualizar&acao_retorno=arvore_visualizar&id_procedimento=' . $objProcedimentoAPI->getIdProcedimento() . '&arvore=1') . '" tabindex="" class="botaoSEI"><img class="infraCorBarraSistema" src="' . MdGestaoDocumentalIntegracao::getDiretorio() . '/imagens/arquivo.svg" alt="Consultar Hist�rico de Arquivamento do Processo" title="Consultar Hist�rico de Arquivamento do Processo" /></a>';
        }
    ...
    public function atualizarAssuntoProcesso(ProcedimentoAPI $objProcedimentoAPI) {
        ...
        try{
            ...
            throw new InfraException('Erro alterando historico do modulo gest�o documental',$e);
        }
    ...
    public function montarBotaoDocumento(ProcedimentoAPI $objProcedimentoAPI, $arrObjDocumentoAPI) {
       ...
       // $objAtividadeDTO->setOrdStrSiglaUnidade(InfraDTO::$TIPO_ORDENACAO_ASC);
        ...
        // Bot�o de arquivamento do processo
        ...
        // Bot�o de desarquivamento do processo
        if ($bolAcaoDesarquivamento && $bolArquivado) {
            $arrBotoes[] = '<a href="' . SessaoSEI::getInstance()->assinarLink('controlador.php?acao=gd_procedimento_desarquivar&acao_origem=arvore_visualizar&acao_retorno=arvore_visualizar&id_procedimento=' . $objProcedimentoAPI->getIdProcedimento() . '&arvore=1') . '" tabindex="" class="botaoSEI"><img class="infraCorBarraSistema" src="' . MdGestaoDocumentalIntegracao::getDiretorio() . '/imagens/desarquivamento.png" alt="Desarquivar Processo" title="Desarquivar Processo" /></a>';
        }
    ...
    public function processarControlador($strAcao) {
        switch ($strAcao) {
            ...
            // Par�metros de configuira��o do m�dulo de arquivamento
            case 'gd_parametro_alterar':
                require_once dirname(__FILE__) . '/gd_parametro_alterar.php';
                return true;

            // Modelos de documento do m�dulo
            ...
            // Gest�o das listagens de elimina��o
            ...
            // Edi��o da listagem de elimina��o
            ...
            // Edi��o da listagem de recolhimento
            ...
            // Gest�o das listagens de recolhimento
    ...
    public function montarMensagemProcesso(ProcedimentoAPI $objProcedimentoAPI) {
        ...
        if($objMdGdArquivamentoRN->contar($objMdGdArquivamentoDTO) == 1){
            ...
            if($objMdGdArquivamentoDTO->getStrSituacao() == MdGdArquivamentoRN::$ST_ENVIADO_RECOLHIMENTO){
                $strMsg .= 'Processo inclu�do em listagem de recolhimento.';
            }else if($objMdGdArquivamentoDTO->getStrSituacao() == MdGdArquivamentoRN::$ST_ENVIADO_ELIMINACAO){
                $strMsg .= 'Processo inclu�do em listagem de elimina��o.';
            ...
            if($objMdGdArquivamentoDTO && $objMdGdArquivamentoDTO->getStrSituacao() == MdGdArquivamentoRN::$ST_FASE_EDICAO){
                $strMsg = 'Processo arquivado em fase de corre��o. A a��o deve ser conclu�da no Arquivo da Unidade '.$objMdGdArquivamentoDTO->getStrSiglaUnidadeCorrente().'. </br></br> <span style="font-weight:bold">Motivo da devolu��o:</span> ' . $objMdGdArquivamentoDTO->getStrObservacaoDevolucao();
            }
    ...
    public function excluirDocumento(DocumentoAPI $objDocumentoAPI){
        ...
        // Valida se o documento n�o est� vinculado a uma lista de elimina��o
        ...
        if($objMdGdListaEliminacaoRN->contar($objMdGdListaEliminacaoDTO) > 0){
            $objInfraException->lancarValidacao('O documento n�o pode ser exclu�do!');
            return false;
        }

        // Valida se o documento n�o est� vinculado a uma lista de recolhimento
        ...
        foreach($arrObjProcedimentoAPI as $objProcedimentoAPI) {
            ...
            if ($objProcedimentoDTO->getStrStaEstadoProtocolo() != ProtocoloRN::$TE_PROCEDIMENTO_BLOQUEADO) {
                ...
                if($objMdGdArquivamentoDTO) {
                    if($objMdGdArquivamentoDTO->getStrSituacao() == MdGdArquivamentoRN::$ST_FASE_EDICAO){
                        $objInfraException = new InfraException();
                        $objInfraException->lancarValidacao('O processo n�o pode ser conclu�do.');
                        return false;
                    }
                }
    ...
    public function gerarDocumento(DocumentoAPI $objDocumentoAPI){
        ...
        if($objMdGdArquivamentoDTO) {
            if($objMdGdArquivamentoDTO->getStrSituacao() == MdGdArquivamentoRN::$ST_FASE_EDICAO){
                $objInfraException = new InfraException();
                $objInfraException->lancarValidacao('O documento n�o pode ser inclu�do pois o processo encontra-se em corre��o no arquivo da unidade '.$objMdGdArquivamentoDTO->getStrSiglaUnidadeCorrente().'.');
                return false;
            }
        }
    ...
    public function anexarProcesso(ProcedimentoAPI $objProcedimentoAPIPrincipal, ProcedimentoAPI $objProcedimentoAPIAnexado){
        ...
        if($objMdGdArquivamentoRN->contar($objMdGdArquivamentoDTO) != 0){
            $objInfraException = new InfraException();
            $objInfraException->lancarValidacao('O processo n�o pode ser anexado pois encontra-se arquivado!');
            return false;
        }
