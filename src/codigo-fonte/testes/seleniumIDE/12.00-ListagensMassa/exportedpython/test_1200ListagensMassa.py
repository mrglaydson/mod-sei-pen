...
<<<<<<< HEAD:codigo-fonte/testes/seleniumIDE/12.00-ListagensMassa/exportedpython/test_1200ListagensMassa.py
    time.sleep(0.002)
    self.driver.find_element(By.ID, "chkInfraItem0").click()
=======
    time.sleep(2)
    self.driver.find_element(By.XPATH, "//input[@id='chkInfraItem0']/..").click()
>>>>>>> padronizacao-gestaodocumental:src/codigo-fonte/testes/seleniumIDE/12.00-ListagensMassa/exportedpython/test_1200ListagensMassa.py
