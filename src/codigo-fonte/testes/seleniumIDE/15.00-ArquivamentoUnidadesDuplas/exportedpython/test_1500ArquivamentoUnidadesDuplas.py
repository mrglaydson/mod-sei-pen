...
class Test1500ArquivamentoUnidadesDuplas():
  ...
  def test_cadastrarProcessosFlood5(self):
    ...
    self.driver.switch_to.default_content()
    self.driver.switch_to.frame(1)
    WebDriverWait(self.driver, 30).until(expected_conditions.visibility_of_element_located((By.XPATH, "//*[contains(@title,'Enviar Processo')]")))
    ...
    self.driver.find_element(By.XPATH, "//input[@id='txtUnidade']").send_keys("TESTE")
    time.sleep(2)
    ...
    self.driver.find_element(By.XPATH, "//input[@id='chkSinManterAberto']/..").click()
    ...
    WebDriverWait(self.driver, 30).until(expected_conditions.visibility_of_element_located((By.XPATH, "//div[@id=\'divInfraAreaTabela\']/table/tbody/tr[2]")))
