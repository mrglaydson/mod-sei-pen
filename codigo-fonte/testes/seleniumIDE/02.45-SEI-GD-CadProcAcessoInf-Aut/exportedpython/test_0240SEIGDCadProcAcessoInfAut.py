...
class Test0240SEIGDCadProcAcessoInfAut():
  ...
  def test_cadastrarProcessosFlood(self):
    ...
    self.driver.find_element(By.ID, "lblPublico").click()
    self.driver.find_element(By.ID, "filArquivo").send_keys(os.getcwd()+"/codigo-fonte/testes/seleniumIDE/02.45-SEI-GD-CadProcAcessoInf-Aut/exportedpython/teste.pdf")
