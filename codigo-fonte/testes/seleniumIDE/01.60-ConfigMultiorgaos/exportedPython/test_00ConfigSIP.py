...
class Test00ConfigSIP():
  ...
  def test_sIPCriarMontarOrgao(self):
    ...
    self.driver.find_element(By.XPATH, "//ul[@id=\'main-menu\']/li[2]/a").click()
  ...
  def test_sIPCriarMontarUnidades(self):
    ...
    self.driver.find_element(By.ID, "btnNova").click()
    self.driver.find_element(By.ID, "chkRaiz").click()
    WebDriverWait(self.driver, 30000).until(expected_conditions.element_to_be_clickable((By.ID, "selUnidadeSuperior")))
  ...
  def test_sIPCriarMontarUsers(self):
    ...
    self.driver.find_element(By.ID, "selUnidade").click()
    dropdown = self.driver.find_element(By.ID, "selUnidade")
    dropdown.find_element(By.CSS_SELECTOR, "*[value='110000008']").click()
    print(str("un2"))
