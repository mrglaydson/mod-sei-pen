...
class Test01ConfigSEI():
  ...
  def test_unidadesArquivamento(self):
    ...
    WebDriverWait(self.driver, 30).until(expected_conditions.visibility_of_element_located((By.LINK_TEXT, "Administração")))
    self.driver.find_element(By.LINK_TEXT, "Administração").click()
    self.driver.find_element(By.CSS_SELECTOR, "li:nth-child(28) > .infraAnchorMenu > span").click()
    self.driver.find_element(By.CSS_SELECTOR, "#submenu140 > li:nth-child(4) > .infraAnchorMenu > span").click()
    self.driver.find_element(By.CSS_SELECTOR, "#submenu146 > li:nth-child(2) span").click()
