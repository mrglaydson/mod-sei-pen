...
class Test1600ArquivamentoAssuntosMultiplos():
  ...
  def test_01ProcCadMultiAssunto(self):
    ...
    WebDriverWait(self.driver, 30000).until(expected_conditions.visibility_of_element_located((By.CSS_SELECTOR, ".botaoSEI:nth-child(17) > .infraCorBarraSistema")))
    self.driver.find_element(By.CSS_SELECTOR, ".botaoSEI:nth-child(17) > .infraCorBarraSistema").click()
    time.sleep(2000)
    self.driver.switch_to.default_content()
