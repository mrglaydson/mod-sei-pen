...
class Test1900Relacionado():
  ...
  def test_cadastrarProcessosarrecadacao(self):
    self.driver.get(os.environ["base_url"]+"/sip/login.php?sigla_orgao_sistema=ME&sigla_sistema=SEI&infra_url=L3NlaS8=")
  ...
  def test_cadastrarProcessosacessoinf(self):
    ...
    self.driver.switch_to.default_content()
    self.driver.switch_to.frame(1)
    WebDriverWait(self.driver, 30).until(expected_conditions.visibility_of_element_located((By.XPATH, "//img[@title='Relacionamentos do Processo']/..")))
    self.driver.find_element(By.XPATH, "//img[@title='Relacionamentos do Processo']/..").click()
    self.driver.find_element(By.ID, "txtProtocolo").send_keys("99897.000005")
    self.driver.find_element(By.ID, "btnPesquisar").click()
    time.sleep(2)
    self.driver.find_element(By.ID, "sbmAdicionar").click()
    WebDriverWait(self.driver, 30).until(expected_conditions.visibility_of_element_located((By.XPATH, "//a[. = '99897.000005/2037-52'  and @title='Arrecadação: Receita' ]")))
    self.driver.switch_to.default_content()
    self.driver.switch_to.frame(0)
    self.driver.find_element(By.XPATH, "//span").click()
    self.driver.switch_to.default_content()
    ...
    self.driver.switch_to.default_content()
    self.driver.switch_to.frame(1)
    WebDriverWait(self.driver, 30000).until(expected_conditions.visibility_of_element_located((By.CSS_SELECTOR, ".botaoSEI:nth-child(11) > .infraCorBarraSistema")))
    self.driver.find_element(By.CSS_SELECTOR, ".botaoSEI:nth-child(11) > .infraCorBarraSistema").click()
    ...
    elements = self.driver.find_elements(By.XPATH, "//td[contains(.,\'2 anos\')]")
    assert len(elements) > 0
