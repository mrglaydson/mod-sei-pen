...
class Test0220SEIGDCadProcEventoInstAut():
  ...
  def test_cadastrarProcessosFlood(self):
    ...
    self.driver.find_element(By.ID, "lblPublico").click()
    # self.driver.find_element(By.ID, "filArquivo").click()
    self.driver.find_element(By.ID, "filArquivo").send_keys(os.getcwd()+"/codigo-fonte/testes/seleniumIDE/02.25-SEI-GD-CadProcEventoInst-Aut/exportedpython/teste.pdf")
