...
class Test03GDPendenciasArquivamento():
  ...
  def test_040PendenciasArquivamentoArquivarMassa(self):
    ...
    WebDriverWait(self.driver, 120000).until(expected_conditions.presence_of_element_located((By.XPATH, "//*[@id=\"divInfraAreaTabela\"]/table/caption")))
  ...
  def test_060ArquivoUnidadeDesarquivarMassa(self):
    ...
    self.driver.find_element(By.ID, "pwdSenha").send_keys("arquivista01")
    self.driver.find_element(By.ID, "sbmSalvar").click()
    WebDriverWait(self.driver, 120000).until(expected_conditions.visibility_of_element_located((By.CSS_SELECTOR, ".infraCaption")))
  ...
  def test_080PendenciasArquivamentoArquivarMassa(self):
    ...
    self.driver.find_element(By.ID, "pwdSenha").send_keys("arquivista01")
    self.driver.find_element(By.ID, "sbmSalvar").click()
    WebDriverWait(self.driver, 120000).until(expected_conditions.presence_of_element_located((By.CSS_SELECTOR, ".infraCaption")))
    self.driver.find_element(By.CSS_SELECTOR, ".infraCaption").click()
