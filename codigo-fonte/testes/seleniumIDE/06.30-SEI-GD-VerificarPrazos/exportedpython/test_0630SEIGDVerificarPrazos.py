...
class Test0630SEIGDVerificarPrazos():
  ...
  def test_0620VerificarPrazosUnidadeTeste(self):
    ...
    assert self.driver.find_element(By.XPATH, "//td[contains(.,\'0 ano\')]").text == "0 anos, 9 meses e 18 dias."
  ...
  def test_0630VerificarPrazosUnidadeArquivo(self):
    ...
    self.driver.find_element(By.ID, "sbmLogin").click()
    self.driver.find_element(By.LINK_TEXT, "Arquivo da Unidade").click()
    WebDriverWait(self.driver, 30000).until(expected_conditions.invisibility_of_element_located((By.XPATH, "//td[contains(.,\'0 ano\')]")))
