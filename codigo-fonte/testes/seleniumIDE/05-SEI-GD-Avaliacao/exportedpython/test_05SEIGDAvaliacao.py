...
class Test05SEIGDAvaliacao():
  ...
  def test_0520VerificaVolta(self):
    ...
    WebDriverWait(self.driver, 30).until(expected_conditions.visibility_of_element_located((By.CSS_SELECTOR, ".botaoSEI:nth-child(3) > .infraCorBarraSistema")))
    ...
    WebDriverWait(self.driver, 30).until(expected_conditions.visibility_of_element_located((By.CSS_SELECTOR, "#divInfraBarraComandosSuperior .infraTeclaAtalho")))
