...
class Test1300ArquivamentoLegado():
  ...
  def test_01Legado(self):
    ...
    assert self.driver.find_element(By.CSS_SELECTOR, ".infraCaption").text == "Lista de Processos Arquivados (95 registros - 1 a 50):"
  ...
  #   self.driver.find_element(By.XPATH, "//td[contains(.,\'Unidade de Testes 1.2\')]").click()
  #   self.driver.find_element(By.CSS_SELECTOR, ".d-none #lnkInfraUnidade").click()
  #   self.driver.find_element(By.XPATH, "//td[contains(.,\'ArquivoGeral02\')]").click()
