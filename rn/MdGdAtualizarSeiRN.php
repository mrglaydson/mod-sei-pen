...
class MdGdAtualizarSeiRN extends InfraRN {
    ...
    protected function atualizarV100Conectado() {
        try {
            ...
            // Cria a tabela de anotaчѕes das pendъncias de arquivamento
            ...
            // Cria a tabela ternсria entre a listagem de recolhimento e procedimento
            ...
            // Cria a tabela de relacionamento de documentos fэsicos recolhidos
