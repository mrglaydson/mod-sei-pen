...
function inicializar(){
  ...
  if (document.getElementById('selPais').value==76 ) {
...
?>
  ...
  <input type="text" id="txtLatitude" name="txtLatitude" onkeypress="return infraMascaraDecimais(this, '', ',', event, 8, 11)" class="infraText" value="<?=PaginaSEI::tratarHTML($objCidadeDTO->getDblLatitude());?>" tabindex="<?=PaginaSEI::getInstance()->getProxTabDados()?>" />
  ...
  <input type="text" id="txtLongitude" name="txtLongitude" onkeypress="return infraMascaraDecimais(this, '', ',', event, 8, 11)" class="infraText" value="<?=PaginaSEI::tratarHTML($objCidadeDTO->getDblLongitude());?>" tabindex="<?=PaginaSEI::getInstance()->getProxTabDados()?>" />
